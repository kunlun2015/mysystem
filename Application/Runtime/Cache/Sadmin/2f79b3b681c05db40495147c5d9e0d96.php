...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>My System Login Page</title>
        ...
        <link href="<?php echo C('STATIC_URL');?>assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo C('STATIC_URL');?>assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <script src="<?php echo C('STATIC_URL');?>assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="<?php echo C('STATIC_URL');?>assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
